<div class="grid xs-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 xl:gap-8 md:gap-4 sm:gap-2 gap-1 md:px-4 px-2 ">
  ...
  while ($row = mysqli_fetch_array($result)) { ?>
    <div class="my-6 max-w-sm rounded-lg border border-gray-100 bg-white shadow-xl">
      <a class="mx-3 mt-3 flex justify-center items-center h-60 overflow-hidden rounded-xl" href="products1.php?nama_minuman=<?php echo $row['nama_minuman']; ?>">
      ...
      <div class="mt-4 px-5 pb-5">
        ...
        <button href="#" onclick="addToCart(event)"
          class="flex items-center justify-center rounded-sm bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
