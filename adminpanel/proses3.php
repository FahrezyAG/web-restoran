                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            <div class="mb-6">
                                ...
                                <input name="nama" value="<?php echo $data['nama_minuman'] ?>"
...
if (isset($_POST["submit"])) {
    ...
    $result = mysqli_query($conn, "UPDATE minuman SET nama_minuman='$nama', deskripsi= '$deskripsi', harga = '$harga' WHERE id = $id");
    echo "<script> window.location.href='listminuman.php';</script>";
