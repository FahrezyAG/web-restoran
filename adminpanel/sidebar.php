...
<body class = "body bg-white dark:bg-[#0F172A]">
    ...
    <aside class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
        <!-- open sidebar button -->
        <div class = "animate-pulse max-toolbar translate-x-24 scale-x-0 w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-slate-500  absolute top-2 rounded-full h-12">
            </div>
