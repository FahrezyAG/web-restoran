...
$nama = htmlspecialchars($_GET["nama_minuman"]);
$query = mysqli_query($conn, "SELECT * FROM minuman WHERE nama_minuman='$nama'");
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1"><?php echo $produk['nama_minuman']; ?></h1>
        <div class="flex mb-4">
